    ...
    >
      ...
      {!aiChatOpen ? (
        ...
        <div className="flex-1 flex flex-col bg-gray-50 relative">
          <div className="p-4 bg-white flex items-center gap-4 shadow-sm border-b border-gray-100">
            <button onClick={() => setAiChatOpen(false)}>
              <i className="fa-solid fa-arrow-left text-gray-800"></i>
            </button>
            <div className="flex flex-col">
              <span className="font-bold text-sm text-black">Assistente Uber IA</span>
          ...
          <div className="p-4 bg-white border-t border-gray-100 flex gap-2">
            <input 
              ...
              className="flex-1 bg-gray-100 text-black rounded-full px-4 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500"
            />
            <button 
