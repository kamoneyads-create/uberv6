  ...
  return (
    <div className="h-full bg-white flex flex-col overflow-y-auto pb-0 transition-colors duration-300">
      ...
      >
        ...
        <button className="p-2">
          <i className="fa-solid fa-circle-question text-xl text-black"></i>
        </button>
      </div>
      ...
      <div className="flex flex-col items-center mt-2">
        <div className="flex items-center justify-center gap-12 w-full px-4">
          ...
          <h1 className="text-[40px] font-medium tracking-tight text-black">R$ 0,00</h1>
      ...
      <div className="px-6 mt-12">
        <h2 className="text-[28px] font-bold mb-6 text-black">Estatísticas</h2>
        
        <div className="grid grid-cols-2 gap-y-8">
          <div>
            <p className="text-gray-500 text-base mb-1">Online</p>
            <p className="text-[22px] font-bold text-black">0 h 0 m</p>
          </div>
          <div>
            <p className="text-gray-500 text-base mb-1">Viagens</p>
            <p className="text-[22px] font-bold text-black">0</p>
          </div>
      ...
      <div className="px-6 mt-10">
        <h2 className="text-[28px] font-bold mb-6 text-black">Detalhamento</h2>
        
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <span className="text-lg text-gray-800">Valor líquido</span>
            <span className="text-lg font-medium text-black">R$ 0,00</span>
          </div>
          <div className="flex justify-between items-center">
